...
import math
import smbus
def servorun(mainServoPosition):

    mainServoNumber = mainServoPosition
    ...
    class I2C_Controller:
        ...
        def read_data(self, register):
            ...
            if (self.debug):
                print("I2C: Device 0x%02X returned 0x%02X from reg 0x%02X" % (self.address, data & 0xFF, register))
            return data
    ...
    if __name__=='__main__':
        ...
        controller.Set_Pulse(15,mainServoNumber)   #setting 15th pin of the servo header(backward direction)
        #       sleep(0.05)  
    return None